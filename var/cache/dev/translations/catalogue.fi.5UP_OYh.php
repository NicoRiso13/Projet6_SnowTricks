...
$catalogue = new MessageCatalogue('fi', array (
  ...
  array (
    ...
    'The image is square ({{ width }}x{{ height }}px). Square poster are not allowed.' => 'Kuva on neliä ({{ width }}x{{ height }}px). Neliöt kuvat eivät ole sallittuja.',
    'The image is landscape oriented ({{ width }}x{{ height }}px). Landscape oriented poster are not allowed.' => 'Kuva on vaakasuuntainen ({{ width }}x{{ height }}px). Vaakasuuntaiset kuvat eivät ole sallittuja.',
    'The image is portrait oriented ({{ width }}x{{ height }}px). Portrait oriented poster are not allowed.' => 'Kuva on pystysuuntainen ({{ width }}x{{ height }}px). Pystysuuntaiset kuvat eivät ole sallittuja.',
