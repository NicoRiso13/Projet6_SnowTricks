...
class __TwigTemplate_338fed74dbe514cea8f7f6b9fa6d8957f678ea8906f64208345652f05c18d91f extends Template
{
    private $source;
    private $macros = [];
    ...
    public function macro_render_bus_messages($__messages__ = null, $__showBus__ = false, ...$__varargs__)
    {
        ...
        <thead>
            <tr>
                ...
                // line 122
                echo twig_include($this->env, $context, "@WebProfiler/poster/icon-minus-square.svg");
                echo "</span>
                        <span class=\"icon icon-open\">";
                // line 123
                echo twig_include($this->env, $context, "@WebProfiler/poster/icon-plus-square.svg");
                echo "</span>
                    </a>
                </th>
            </tr>
...
{% macro render_bus_messages(messages, showBus = false) %}
            ...
            <tr>
                ...
                >
                    ...
                    <a class=\"toggle-button\">
                        <span class=\"icon icon-close\">{{ include('@WebProfiler/poster/icon-minus-square.svg') }}</span>
                        <span class=\"icon icon-open\">{{ include('@WebProfiler/poster/icon-plus-square.svg') }}</span>
                    </a>
                </th>
            </tr>
        </thead>
    ...
    {% endfor %}
{% endmacro %}
", "@WebProfiler/Collector/messenger.html.twig", "C:\\wamp64\\www\\SnowTricks\\vendor\\symfony\\web-profiler-bundle\\Resources\\views\\Collector\\messenger.html.twig");
    }
}
