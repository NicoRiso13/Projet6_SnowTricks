...
class __TwigTemplate_feef488019107d553792fa439017319d79cc434d005afdf6b33bd610e648890a extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 8
        echo "    <div class=\"bloc-erreur-500\">
        <div class=\"bloc-logo-500\">
            <h1>";
        // line 10
        echo twig_escape_filter($this->env, (isset($context["status_code"]) || array_key_exists("status_code", $context) ? $context["status_code"] : (function () { throw new RuntimeError('Variable "status_code" does not exist.', 10, $this->source); })()), "html", null, true);
        echo " ";
        echo twig_escape_filter($this->env, (isset($context["status_text"]) || array_key_exists("status_text", $context) ? $context["status_text"] : (function () { throw new RuntimeError('Variable "status_text" does not exist.', 10, $this->source); })()), "html", null, true);
        echo "</h1>
            <img alt=\"logo-500\" class=\"logo-500\" src=\"/img/error/ERREUR_500.png\"/>
        </div>
        <P class=\"oups-500\"> Oups !!</P>
        <P class=\"message-500\"> Le réseau a rencontré un problème... <a class=\"link-home-500\" href=\"/\">Retour à l'accueil</a> </P>
    </div>
...
";
    ...
    {
        return array (  94 => 10,  90 => 8,  80 => 7,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "@Twig/Exception/error500.html.twig", "C:\\wamp64\\www\\SnowTricks\\templates\\bundles\\TwigBundle\\Exception\\error500.html.twig");
    }
}
